...
pub mod VMInst {
    ...
    pub const CREATE_ARRAY: u8 = 0x02;
    pub const PUSH_INT8: u8 = 0x03;
    pub const PUSH_INT32: u8 = 0x04;
    pub const PUSH_FALSE: u8 = 0x05;
    pub const PUSH_TRUE: u8 = 0x06;
    pub const PUSH_CONST: u8 = 0x07;
    pub const PUSH_NULL: u8 = 0x08;
    pub const PUSH_THIS: u8 = 0x09;
    pub const PUSH_ARGUMENTS: u8 = 0x0a;
    pub const PUSH_UNDEFINED: u8 = 0x0b;
    pub const PUSH_SEPERATOR: u8 = 0x0c;
    pub const POP: u8 = 0x0d;
    pub const SPREAD_ARRAY: u8 = 0x0e;
    pub const DOUBLE: u8 = 0x0f;
    pub const LNOT: u8 = 0x10;
    pub const POSI: u8 = 0x11;
    ...
    pub const EXP: u8 = 0x18;
    pub const LAND: u8 = 0x19;
    pub const LOR: u8 = 0x1a;
    pub const NOT: u8 = 0x1b;
    pub const LT: u8 = 0x1c;
    pub const GT: u8 = 0x1d;
    pub const LE: u8 = 0x1e;
    pub const GE: u8 = 0x1f;
    pub const EQ: u8 = 0x20;
    pub const NE: u8 = 0x21;
    pub const SEQ: u8 = 0x22;
    pub const SNE: u8 = 0x23;
    pub const AND: u8 = 0x24;
    pub const OR: u8 = 0x25;
    pub const XOR: u8 = 0x26;
    pub const SHL: u8 = 0x27;
    pub const SHR: u8 = 0x28;
    pub const ZFSHR: u8 = 0x29;
    pub const JMP_IF_FALSE: u8 = 0x2a;
    pub const JMP_IF_TRUE: u8 = 0x2b;
    pub const JMP: u8 = 0x2c;
    pub const CALL: u8 = 0x2d;
    pub const CALL_METHOD: u8 = 0x2e;
    pub const CONSTRUCT: u8 = 0x2f;
    pub const RETURN: u8 = 0x30;
    pub const GET_MEMBER: u8 = 0x31;
    pub const SET_MEMBER: u8 = 0x32;
    pub const GET_VALUE: u8 = 0x33;
    pub const SET_VALUE: u8 = 0x34;
    pub const DECL_VAR: u8 = 0x35;
    pub const DECL_CONST: u8 = 0x36;
    pub const DECL_LET: u8 = 0x37;
    pub const PUSH_ENV: u8 = 0x38;
    pub const POP_ENV: u8 = 0x39;
    pub const COND_OP: u8 = 0x3a;
    pub const LOOP_START: u8 = 0x3b;
    pub const THROW: u8 = 0x3c;
    pub const RETURN_TRY: u8 = 0x3d;
    pub const SET_OUTER_ENV: u8 = 0x3e;
